...
| ❤️ **Health** | Steps ring vs. goal, water counter, sleep log, mood picker, steps-per-week chart with goal line. **Navigate to any past day** to fill in what you forgot |
...
| 🎓 **Skills & Education** | Your **self-directed learning** hub: monthly study-hours goal, one-tap study logging, an **8-week study-time trend** chart, and courses/skills you can **edit, categorize, mark complete** and track by progress. **Log study time against any day**, not just today. |
...
| 🏛️ **University** | Your **formal coursework**: weekly study-hours goal and **assignments/deadlines** with a course/subject label, editable tasks, due-date tags and **overdue** highlighting. **Day navigation** for backfilling study hours. |
...
| ✒️ **Journal** | Daily entry with mood and tags, past-entry timeline. **Any day is editable** — navigate back, or tap a past entry to open and rewrite it |
