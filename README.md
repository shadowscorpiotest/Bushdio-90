...
| 💪 **Workout** | Weekly goal, a plan with **categories** (Calisthenics / Strength / Cardio / Mobility / Yoga), and **per-day sessions** you can navigate. Log **exercises with real sets** — *weight × reps*, *time/holds*, or *distance* — and the app tracks **personal records** (with a PR toast) plus a **per-exercise progress chart** and full session history. Each session also takes a note and **photo & video uploads** to rewatch a lift |
